    ...
    <div class="table" v-loading="loading" element-loading-text="加载中">
        <div class="container">
            ...
            <el-table :data="tableData" border size="medium" ref="multipleTable"  stripe>
                ...
                <el-table-column prop="url" label="投放链接" align="center" width="500"></el-table-column>
                <el-table-column prop="admin_id" label="渠道联系人" align="center"></el-table-column>
            ...
            　　　　    <img :src="scope.row.qrcode" width="40" height="40" class="head_pic"/>
            　　    </template>
                </el-table-column>
