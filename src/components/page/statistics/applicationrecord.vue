<template>
        <div class="table" v-loading="loading" element-loading-text="加载中">
            <div class="container">
                <div class="container-title">用户申请记录</div>
                <div class="mgb20">
                        <el-row >
                                <el-col :span="4">
                                    <el-button type="primary">累计申请人数</el-button>
                                    <el-button type="primary">今日申请人数</el-button>

                                </el-col>
                                <el-col :span="12">
                                        <el-row :gutter="20">
                                                <el-col :span="6">
                                                        <el-input v-model.trim="s_klass" placeholder="请输入用户手机号码或产品名称" @keyup.enter.native="search"></el-input>
                                                </el-col>
                                                <el-col :span="6">
