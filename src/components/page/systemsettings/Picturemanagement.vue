<template>
        <div class="table" v-loading="loading" element-loading-text="加载中">
            <div class="container">
                <div class="container-title">轮播图管理</div>
                <div class="mgb20">
                    <el-row :gutter="10" class="clearfix">
                            <router-link :to="{path:'addbanner'}"><el-button type="primary">+新增轮播</el-button></router-link>
                ...
                <el-table :data="tableData" border size="medium" ref="multipleTable">
                    ...
                    <el-table-column prop="school" label="地址" align="center"></el-table-column>
                    <el-table-column prop="grade" label="产品id" align="center"></el-table-column>
                    <el-table-column prop="klass" label="类别" align="center"></el-table-column>
                    <el-table-column prop="klass" label="排序" align="center"></el-table-column>
