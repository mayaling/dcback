<template>
        <div class="table" v-loading="loading" element-loading-text="加载中">
            <div class="container">
                <div class="container-title">新建轮播</div>
                <el-form :model="form" ref="form" :rules="rules" class="item-add-list">
                        <el-row :gutter="10" class="clearfix">
                            ...
                            <el-col :span="12">
                                <el-form-item label="展示方式:" prop="projectName">
                                        <el-select v-model="form.region" placeholder="否">
                                                <el-option label="产品" value="shanghai"></el-option>
                        ...
                        <el-row :gutter="10" class="clearfix">
                            <el-col :span="12">
                                <el-form-item label="链接地址" prop="memo">
                                    <el-input v-model.trim="form.projectNo" type="text"></el-input>
                                    <span style='color:#999'> 链接到的外部地址</span>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="产品id" prop="memo">
                                    <el-input v-model.trim="form.projectNo" type="text"></el-input>
                                    <span style='color:#999'> 产品id</span>
                                    <span></span>
                                </el-form-item>
                            </el-col>
                        </el-row>               
                        <el-row :gutter="10" class="clearfix">
                            <el-col :span="12">
                                    <el-form-item label="排序" prop="memo">
                                            <el-input v-model.trim="form.projectNo" type="text"></el-input>
                                            <span style='color:#999'>用于显示的顺序,越小越靠前</span>
                                            <span></span>
                                        </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                    <el-form-item label="状态" prop="memo">
                                            <el-select v-model="form.region" placeholder="否">
                        ...
                        <el-row :gutter="10" class="clearfix">
                          <el-col :span="20" :offset="4">
                            ...
                            <router-link :to="{path:'Picturemanagement'}"><el-button type="primary">取消</el-button></router-link>
