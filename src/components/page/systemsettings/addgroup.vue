<template>
        <div class="table" v-loading="loading" element-loading-text="加载中">
            <div class="container">
                <div class="container-title">新建用户组</div>
                <el-form :model="form" ref="form" :rules="rules" class="item-add-list">
                        <el-row :gutter="20">
                                <el-col :span="8" :offset="2">
                                        <el-form-item label="标题:" prop="projectNo">
                                              ...
                                              <el-form-item label="类型:" prop="projectNo">
                                                    <el-select v-model="form.region" placeholder="代理">
                                                            <el-option label="代理" value="shanghai"></el-option>
                                                            <el-option label="后台" value="beijing"></el-option>
                                                        </el-select>
                                                  </el-form-item>
                                                  <el-form-item label="描述:" prop="des">
                                                        <el-input v-model.trim="form.des" type="textarea"></el-input>
                                                      </el-form-item>
                                </el-col>
                              </el-row>
                        <el-row :gutter="10" class="clearfix">
                          <el-col :span="20" :offset="4">
                            ...
                            <router-link :to="{path:'usergroupmanagement'}"><el-button type="primary">取消</el-button></router-link>
