<template>
    <div class="table" v-loading="loading" element-loading-text="加载中">
        <div class="container">
            <div class="container-title">菜单管理</div>
            <div class="mgb20">
                <el-row :gutter="10" class="clearfix">
                        <router-link :to="{path:'addmenu'}"><el-button type="primary">+新增菜单</el-button></router-link>
            ...
            <el-table :data="tableData" border size="medium" ref="multipleTable">
                <el-table-column prop="name" label="序列" align="center" width="120"></el-table-column>
                <el-table-column prop="englishName" label="名称" align="center"></el-table-column>
                <el-table-column prop="username" label="上级菜单" align="center"></el-table-column>
                <el-table-column prop="school" label="URL" align="center"></el-table-column>
                <el-table-column prop="grade" label="排序" align="center"></el-table-column>
                <el-table-column prop="klass" label="仅开发者模式显示" align="center"></el-table-column>
                <el-table-column prop="klass" label="隐藏" align="center"></el-table-column>
