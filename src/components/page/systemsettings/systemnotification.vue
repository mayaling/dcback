<template>
        <div class="table" v-loading="loading" element-loading-text="加载中">
            <div class="container">
                <div class="container-title">系统通知列表</div>
                <div class="mgb20">
                    <el-row :gutter="10" class="clearfix">
                            <router-link :to="{path:'addnotification'}"><el-button type="primary">+新增</el-button></router-link>
                ...
                <el-table :data="tableData" border size="medium" ref="multipleTable">
                    ...
                    <el-table-column prop="englishName" label="标题" align="center"></el-table-column>
                    <el-table-column prop="username" label="图片" align="center"></el-table-column>
                    <el-table-column prop="school" label="简介" align="center"></el-table-column>
                    <el-table-column prop="grade" label="地址" align="center"></el-table-column>
                    <el-table-column prop="klass" label="相关数据" align="center"></el-table-column>
                    <el-table-column prop="klass" label="通知类型" align="center"></el-table-column>
                    <el-table-column prop="klass" label="目标组/用户" align="center"></el-table-column>
                    <el-table-column prop="klass" label="时间" align="center"></el-table-column>
